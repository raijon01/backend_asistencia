...
for /f %%x in ('powershell Get-Date -Format "yyyyMMdd-HHmmss"') do set "mensajeawesomeTSFrontWeb=TS-FrontWeb-Asis-%%x"
...
start cmd.exe /k "cd C:\Users\nicolas\Desktop\TypeScript\TS_FrontWeb_ProyectoAsis & git add . & git commit -m %mensajeawesomeTSFrontWeb% & git push origin main" 